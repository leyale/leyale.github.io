...
function css(obj, attr, value){  //  设置css的transform中的各个属性
...
function setCss3(obj, attr, value)  //  设置css的transform中的各个属性，以便于做多个transform属性
{
	var sTr="";
	var sVal="";
...
{
	var obj = option.obj;
	var oTarget = option.oTarget;  //需要修改的属性
	var iTime = option.iTime;
	var iType = option.iType;   //运动形式
